...
def main():
    ...
    required_location = input("Enter any locations that must be apart of your trip:") or ""
    required_locations_list = required_location.split(", ")
    forbidden_location = input("Enter any locations that you do not want to be apart of your trip:") or ""
    forbidden_locations_list = forbidden_location.split(", ")
    """
